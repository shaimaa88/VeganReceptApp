...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.Platform.Android.OpenGLRenderer+Renderer, Xamarin.Forms.Platform.Android, Version=1.3.5.0, Culture=neutral, PublicKeyToken=null", OpenGLRenderer_Renderer.class, __md_methods);
	}
	...
	public OpenGLRenderer_Renderer () throws java.lang.Throwable
	{
		...
		if (getClass () == OpenGLRenderer_Renderer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.Platform.Android.OpenGLRenderer+Renderer, Xamarin.Forms.Platform.Android, Version=1.3.5.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
